...
---@alias voidvim.util.cmp.Action fun():boolean?
---@type table<string, voidvim.util.cmp.Action>
M.actions = {
  -- Native Snippets
...
function M.setup(opts)
  ...
  require("cmp.utils.snippet").parse = function(input)
    ...
    return VoidVim.cmp.snippet_preview(input)
  end
